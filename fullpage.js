/*fullPage 3.0.7*/ !(function (e, t, n, o, r) {
        ...
        function (e, E) {
            ...
            if (!yn(u, Wt)) {
                ...
                var m,
                    ...
                    M,
                    C,
                    B = Rt.PointerEvent ? { down: "pointerdown", move: "pointermove" } : { down: "MSPointerDown", move: "MSPointerMove" },
                    H = { touchmove: "ontouchmove" in Rt ? "touchmove" : B.move, touchstart: "ontouchstart" in Rt ? "touchstart" : B.down },
                        ...
                        (h.destroy = function (e) {
                            J(!1, "internal"),
                                ...
                                e &&
                                    ...
                                    Qn(bn(en + ", " + dn + ", " + pn)),
                                    xn(bn(_t), { height: "", "background-color": "", padding: "" }),
                                    xn(bn(on), { width: "" }),
            ...
            function pe(e) {
                var t = ve();
                e
                    ? t || (J(!1, "internal"), te(!1, "internal"), Bn(bn(en)), In(L, Pt), Xn(E.afterResponsive) && E.afterResponsive.call(d, e), E.scrollOverflow && m.createScrollBarForAll())
                    : t && (J(P.autoScrolling, "internal"), te(P.autoScrolling, "internal"), Hn(bn(en)), Rn(L, Pt), Xn(E.afterResponsive) && E.afterResponsive.call(d, e));
            }
            function he(e) {
                var t = e.target;
                t && Dn(t, en + " a")
                ...
                o != Nt && o
                    ? ("touchend" === t &&
                      ...
                      ("mouseenter" !== t || V) &&
                          ...
                          !r && h.shared.isNormalScrollElement && (re(!0), (h.shared.isNormalScrollElement = !1))))
                    : re(!0);
            }
            function Se() {
                var e = En(),
                    ...
                    1 < n &&
                        (E.controlArrows &&
                            ...
                            "#fff" !== E.controlArrowColor &&
                                (xn(bn(mn, l), { "border-color": "transparent transparent transparent " + E.controlArrowColor }), xn(bn(gn, l), { "border-color": "transparent " + E.controlArrowColor + " transparent transparent" })),
                ...
                if (!E.autoScrolling || E.scrollBar) {
                    ...
                    if (((t = a), (n = bn($t)[0].offsetTop), (o = n + En()), ("up" != t ? n <= Yn() : o >= Yn() + En()) && (yn(bn($t)[0], Xt) || (In(bn($t)[0], Xt), Rn(Fn(bn($t)[0]), Xt))), !yn((e = f[s]), Ft))) {
                        ...
                        w && ((p = w.getAttribute("data-anchor")), (v = Cn(w))),
                            T && (In(e, Ft), Rn(Fn(e), Ft), Xn(E.onLeave) && Re("onLeave", y), Xn(E.afterLoad) && Re("afterLoad", y), Xe(h), We(e), Fe(e), ut(S, b - 1), E.anchors.length && (x = S), St(v, p, S)),
                            clearTimeout(k),
                ...
                if (null != e) {
                    ...
                    if (!((d.activeSection == e && !g) || (E.scrollBar && Yn() === d.dtop && !yn(e, Gt)))) {
                        ...
                        E.autoScrolling &&
                            ...
                            ((p = d).isMovementUp ? Wn(bn($t)[0], Gn(p.activeSection, _t)) : Vn(bn($t)[0], Jn(p.activeSection, _t).reverse()),
                            xt(bn($t)[0].offsetTop),
                            He(),
            ...
            function Pe(e) {
                var t;
                null != (t = e).wrapAroundElements && (t.isMovementUp ? Wn(bn(_t)[0], t.wrapAroundElements) : Vn(bn(_t)[bn(_t).length - 1], t.wrapAroundElements), xt(bn($t)[0].offsetTop), He()),
            ...
            function We(o) {
                E.lazyLoading &&
                    bn("img[data-src], img[data-srcset], source[data-src], source[data-srcset], video[data-src], audio[data-src], iframe[data-src]", Ke(o)).forEach(function (n) {
                        if (
                ...
                (l.xMovement = ((o = l.prevSlideIndex), (r = l.slideIndex), o == r ? "none" : r < o ? "left" : "right")),
                    ...
                    E.onSlideLeave && !l.localIsResizing && "none" !== l.xMovement && Xn(E.onSlideLeave) && !1 === Re("onSlideLeave", l)
                        ...
                        : (In(t, Ft),
                          ...
                          !E.loopHorizontal && E.controlArrows && ($n(bn(gn, i), 0 !== l.slideIndex), $n(bn(mn, i), null != On(t))),
            ...
            function rt(e) {
                ...
                (t = e.slidesNav),
                    (n = e.slideIndex),
                    E.slidesNavigation && null != t && (Rn(bn(Ut, t), Ft), In(bn("a", bn("li", t)[n]), Ft)),
            ...
            function ut(e, t) {
                ...
                (n = e),
                    ...
                    (o = e),
                    (r = t),
                    E.navigation && null != bn(en)[0] && (Rn(bn(Ut, bn(en)[0]), Ft), In(o ? bn('a[href="#' + o + '"]', bn(en)[0]) : bn("a", bn("li", bn(en)[0])[r]), Ft));
            }
            function ft(e) {
                var t = Cn(bn($t)[0], _t),
                    n = Cn(e, _t);
            ...
            function gt(e, t) {
                ...
                if (null != n) {
                    var o,
                        r,
                        i,
                        l = (null == (i = bn(on + '[data-anchor="' + (o = t) + '"]', (r = n))[0]) && ((o = void 0 !== o ? o : 0), (i = bn(on, r)[o])), i);
                    wt(n) === x || yn(n, Ft)
                        ? mt(l)
                        : Ie(n, function () {
                              mt(l);
...
/*page scroll*/ (function (g) {
    "use strict";
    var a = function (c, a) {
        return this.init(c, a);
    };
    (a.defaults = {
        ...
        (a.prototype = {
            init: function (c, a) {
                return c.data("tponePage") ? this : ((this.el = c), this.setOptions(a).build(), this);
            },
            setOptions: function (b) {
                return this.el.data("__tsonePage", this), (this.options = g.extend(!0, {}, a.defaults, b)), this;
            },
            build: function () {
                var a = g(this.el),
                    b = this.options,
                    c = a.data("id");
                a.fullpage(
                    g.extend(!0, {}, this.options, {
                        onLeave: function (a, b) {
                            g(this);
                            g(".fullpage-nav-paginate .slide-nav").removeClass("active animated"), g(".fullpage-nav-paginate .slide-nav[data-slide=" + parseInt(b.index) + "]").addClass("active animated");
                            var c = a.item,
                                d = g(c).closest(".tp-page-scroll-wrapper").data("scroll-nav-id");
                            "" != d &&
                                d != null &&
                                (g("#" + d)
                                    .find(".highlight")
                                ...
                                g("#" + d)
                                    .find("a:eq(" + parseInt(b.index) + ")")
                                    .addClass("highlight"));
                        },
                        afterLoad: function () {
                            var a = g("#" + c).find(".fp-section:not(.active)");
                            a.find(".animate-general").removeClass("animation-done"), a.find(".animate-general").css("opacity", "0"), a.find(".pt_plus_animated_image.bg-img-animated").removeClass("creative-animated");
                            var b = g("#" + c).find(".fp-section.active");
                            g(b)
                                .find(".animate-general:not(.animation-done)")
                                .each(function () {
                                    var a,
                                        c = g(this),
                                        b = c.data("animate-delay");
                                    (a = c.data("animate-type")), c.hasClass("animation-done") ? c.hasClass("animation-done") : c.addClass("animation-done").velocity(a, { delay: b, display: "auto" });
                                }),
                                0 < g(b).find(".pt_plus_animated_svg").length && g(".pt_plus_animated_svg", b).pt_plus_animated_svg(),
                                0 < g(b).find(".pt_plus_animated_image.bg-img-animated").length &&
                                    g(b)
                                        .find(".pt_plus_animated_image.bg-img-animated")
                                        .each(function () {
                                            var a = g(this);
                                            a.hasClass("creative-animated") ? a.hasClass("creative-animated") : a.addClass("creative-animated");
                                        }),
                                0 < g("#" + c).find(".fp-section .elementor-widget[data-settings]").length &&
                                    (a.find(".elementor-widget.animated").each(function () {
                                        var a = g(this),
                                            c = g(this).data("settings");
                                        c != null && c._animation && a.addClass("elementor-invisible").removeClass(c._animation + " animated");
                                    }),
                                    a.find(".elementor-column.animated").each(function () {
                                        var a = g(this),
                                            c = g(this).data("settings");
                                        c != null && c.animation && a.addClass("elementor-invisible").removeClass(c.animation + " animated");
                                    }),
                                    b.find(".elementor-widget:not(.animated)").each(function () {
                                        var a = g(this),
                                            c = g(this).data("settings");
                                        c != null && c._animation && c._animation_delay
                                            ? setTimeout(function () {
                                                  a.removeClass("elementor-invisible").addClass(c._animation + " animated");
                                              }, c._animation_delay)
                                            : c != null && a.removeClass("elementor-invisible").addClass(c._animation + " animated");
                                    }),
                                    b.find(".elementor-column:not(.animated)").each(function () {
                                        var a = g(this),
                                            c = g(this).data("settings");
                                        c != null && c.animation && c.animation_delay
                                            ? setTimeout(function () {
                                                  a.removeClass("elementor-invisible").addClass(c.animation + " animated");
                                              }, c.animation_delay)
                                            : c != null && a.removeClass("elementor-invisible").addClass(c.animation + " animated");
                                    }));
                        },
                    })
                ),
                    g(".fp-nav-btn.fp-nav-next").on("click", function (a) {
                        a.preventDefault(), g.fn.fullpage.moveSectionDown();
                    }),
                    g(".fp-nav-btn.fp-nav-prev").on("click", function (a) {
                        a.preventDefault(), g.fn.fullpage.moveSectionUp();
                    });
            },
        }),
        (g.fn.PlusFullPage = function (b) {
            return this.map(function () {
                var c,
                    h = g(this),
                    d = h.data("full-page-opt");
                return d && (c = g.extend(!0, {}, b, d)), new a(h, c);
            });
        });
}.apply(this, [jQuery]),
    (function (a) {
        var b = function (a, b) {
            var c = a.find(".tp-page-scroll-wrapper"),
                d = c.data("id");
            0 < a.find(".tp-page-scroll-wrapper.tp_full_page").length && (b("#fp-nav").remove(), b("html").hasClass("fp-enabled") && b.fn.fullpage.destroy("all"), b(".tp-page-scroll-wrapper.tp_full_page").PlusFullPage());
        };
        a(window).on("elementor/frontend/init", function () {
            elementorFrontend.hooks.addAction("frontend/element_ready/tp-page-scroll.default", b);
        });
    })(jQuery));
